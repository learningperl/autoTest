	...
	<div class="wrapper contents_wrapper">
		...
		<aside class="sidebar">
			<ul class="tab_nav">
				...
				<li class="active_tab i_32_ui"><a href="Interface.jsp" title="Kit elements">
					...
					<form id="EditForm1" action="../UpdateInterfaceCase" method="post">
						...
						<div class="p_cli1">
							sceneId:<input id="sceneId1" name="sceneId" type="text"
								...
								readonly />&nbsp Description:<input id="Description" name="Description"
					...
					<form id="EditForm" action="../UpdateInterfaceCase" method="post">
						...
						<div class="p_cli1" name="p_cli1">
							...
							order_id:&nbsp<input id="order_id" name="order_id" type="text"
								...
								onfocus='if(this.value=="NULL" || this.value=="undefined"){this.value=""}'
								onblur='if(this.value=="" || this.value=="undefined"){this.value="NULL"}' />
							method:<input id="method" name="method" type="text"
								value="NULL" class="c_input"
								onfocus='if(this.value=="NULL" || this.value=="undefined"){this.value=""}'
								onblur='if(this.value=="" || this.value=="undefined"){this.value="NULL"}' />
						...
						<div class="p_cli2">
							parameter:<input id="parameter" name="parameter" type="text" value="NULL"
								class="c_input"
								onfocus='if(this.value=="NULL" || this.value=="undefined"){this.value=""}'
								onblur='if(this.value=="" || this.value=="undefined"){this.value="NULL"}' />
							...
							checkMethod:<input id="checkMethod" name="checkMethod"
								...
								onfocus='if(this.value=="NULL" || this.value=="undefined"){this.value=""}'
								onblur='if(this.value=="" || this.value=="undefined"){this.value="NULL"}' />
							expRes:<input id="expRes" name="expRes"
								type="text" value="NULL" class="c_input"
								onfocus='if(this.value=="NULL" || this.value=="undefined"){this.value=""}'
								onblur='if(this.value=="" || this.value=="undefined"){this.value="NULL"}' />
						</div>
		...
		<div class="contents">
			<div class="grid_wrapper">
				...
				<div class="g_6 contents_header">
					...
					<div>
						<span class="label"> Your Interface Cases Search, Add, Edit And Run</span>
					</div>
				</div>
					...
					<div class="widget_header">
						...
						<img
							...
							onclick='runTest()' />
						<img
							title="调试接口" src="/WebTester/static/Images/Icons/16/debug.png"
							style="position: relative; top: 2px; left: 20px; cursor: pointer; width: 18px"
							onclick='debugCase()' />
					...
					<section id="conter">
						...
						<section id="help-right"></section>
							<a href="#" id="pop"> </a> <a href="#" id="pop1"> </a> 
					</section>
